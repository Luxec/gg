...
\033[93m>> \033[96mPrivate Tools EXCUTED ++ \033[93m<< 
            \033[97m
             """)
username = str(input("\033[93mUsername:"))
password = str(input("\033[93mPassword:"))
if password == "EXCUTED-Tools" and username == "EXCUTED"
    print ("Success!!!")
    time.sleep(2)
...
os.system("clear")
print("\033[92mConnecting To Tools [\033[97m•\033[92m]")
time.sleep(0.9)

os.system("clear")
print("Connecting To Tools [\033[97m••\033[92m]")
time.sleep(0.9)
